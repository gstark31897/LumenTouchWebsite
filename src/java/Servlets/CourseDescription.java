...
public class CourseDescription extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("               <img style=\"margin-right: 44%;z-index: 90;margin-bottom:-2px;\" src=\"/LumenTouchWebsite/lumen_touch_logo.png\" alt=\"Logo\">");
            ...
            out.println("                   </div>");
            out.println("                   <br>");
            out.println("                   <form name=\"input\" action=\"/LumenTouchWebsite/UserCredentials\" method=\"post\">");
